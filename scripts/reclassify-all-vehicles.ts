    ...
    try {
        ...
        for (let i = 0; i < vehicles.length; i++) {
            ...
            try {
                ...
                console.log(`   💡 Família: ${result.aptoFamilia ? '✅' : '❌'} | Uber: ${result.aptoUber ? '✅' : '❌'} | Black: ${result.aptoUberBlack ? '✅' : '❌'} | Carga: ${result.aptoCarga ? '✅' : '❌'} | Diário: ${result.aptoUsoDiario ? '✅' : '❌'} | Entrega: ${result.aptoEntrega ? '✅' : '❌'} | Viagem: ${result.aptoViagem ? '✅' : '❌'}`);
