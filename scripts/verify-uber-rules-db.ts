...
async function main() {
    ...
    if (renegadeBlack) {
        console.log(`✅ PASS: Renegade found in Uber Black rules (as per Official API). Min Year: ${renegadeBlack.minYear}`);
    ...
    if (sportageBlack) {
        ...
        console.warn('⚠️ WARN: Sportage not found in Uber Black (might be correct for SP, but worth noting)');
    }
