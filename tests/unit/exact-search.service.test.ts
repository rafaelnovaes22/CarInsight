 ...
 */
const versionGenerator = fc.constantFrom('LT', 'LTZ', 'Premier', 'Sport', 'Comfort', 'EX', 'EXL', 'Touring', null);
...
const inventoryWithExactMatchesGenerator = (model: string, year: number, numExactMatches: number) =>
    fc.tuple(
        // Exact matches
        fc.array(vehicleGenerator(model, year), { minLength: numExactMatches, maxLength: numExactMatches }),
                ...
                fc.property(
                    ...
                    (model, year, prices) => {
                        ...
                        for (let i = 1; i < result.vehicles.length; i++) {
                            expect(result.vehicles[i - 1].vehicle.preco)
                                .toBeGreaterThanOrEqual(result.vehicles[i].vehicle.preco);
                        }
                    }
                ),
                { numRuns: 100 }
            ...
            fc.assert(
                fc.property(
                    ...
                    (model, year, mileages) => {
                        ...
                        for (let i = 1; i < result.vehicles.length; i++) {
                            expect(result.vehicles[i - 1].vehicle.km)
                                .toBeLessThanOrEqual(result.vehicles[i].vehicle.km);
                        }
                    }
                ),
                { numRuns: 100 }
        ...
        it('orders by version alphabetically when price and mileage are equal', () => {
            fc.assert(
                fc.property(
                    ...
                    yearGenerator,
                    fc.array(
                        fc.constantFrom('LT', 'LTZ', 'Premier', 'Sport', 'Comfort', 'EX', 'EXL'),
                ...
                fc.property(
                    ...
                    (model, year) => {
                        ...
                        const vehicles: Vehicle[] = [
                            ...
                            { id: 'v1', marca: 'Chevrolet', modelo: model, versao: 'LT', ano: year, km: 50000, preco: 70000, cor: 'Branco', carroceria: 'Hatch', combustivel: 'Flex', cambio: 'Manual', disponivel: true, fotoUrl: null, url: null },
                            // Higher price should come first
                            { id: 'v2', marca: 'Chevrolet', modelo: model, versao: 'LTZ', ano: year, km: 60000, preco: 90000, cor: 'Branco', carroceria: 'Hatch', combustivel: 'Flex', cambio: 'Manual', disponivel: true, fotoUrl: null, url: null },
                            // Same price as v1, lower mileage should come first
                            { id: 'v3', marca: 'Chevrolet', modelo: model, versao: 'Sport', ano: year, km: 30000, preco: 70000, cor: 'Branco', carroceria: 'Hatch', combustivel: 'Flex', cambio: 'Manual', disponivel: true, fotoUrl: null, url: null },
                            // Same price and mileage as v3, version alphabetically later
                            { id: 'v4', marca: 'Chevrolet', modelo: model, versao: 'Comfort', ano: year, km: 30000, preco: 70000, cor: 'Branco', carroceria: 'Hatch', combustivel: 'Flex', cambio: 'Manual', disponivel: true, fotoUrl: null, url: null },
                        ];
            ...
            fc.assert(
                fc.property(
                    ...
                    (model, requestedYear, alternativeYears) => {
                        ...
                        const result = service.search(
                            { model, year: requestedYear, yearRange: null, rawQuery: `${model} ${requestedYear}` },
                            vehicles
                        );
            ...
            fc.assert(
                fc.property(
                    ...
                    (model, requestedYear) => {
                        ...
                        const vehicles: Vehicle[] = [
                            { id: 'v1', marca: 'Chevrolet', modelo: model, versao: 'LT', ano: 2018, km: 50000, preco: 80000, cor: 'Branco', carroceria: 'Hatch', combustivel: 'Flex', cambio: 'Manual', disponivel: true, fotoUrl: null, url: null },
                            { id: 'v2', marca: 'Chevrolet', modelo: model, versao: 'LTZ', ano: 2018, km: 40000, preco: 90000, cor: 'Preto', carroceria: 'Hatch', combustivel: 'Flex', cambio: 'Automático', disponivel: true, fotoUrl: null, url: null },
                            { id: 'v3', marca: 'Chevrolet', modelo: model, versao: 'Premier', ano: 2020, km: 30000, preco: 100000, cor: 'Prata', carroceria: 'Hatch', combustivel: 'Flex', cambio: 'Automático', disponivel: true, fotoUrl: null, url: null },
                            { id: 'v4', marca: 'Chevrolet', modelo: model, versao: 'LT', ano: 2020, km: 60000, preco: 85000, cor: 'Branco', carroceria: 'Hatch', combustivel: 'Flex', cambio: 'Manual', disponivel: true, fotoUrl: null, url: null },
                        ];
...
describe('Property 7: Personalized suggestions match similarity criteria', () => {
     ...
     */
    const vehicleWithBodyTypeGenerator = (bodyType: string, priceRange?: { min: number; max: number }, yearRange?: { min: number; max: number }) =>
        fc.record({
            id: fc.uuid(),
            marca: fc.constantFrom('Chevrolet', 'Honda', 'Toyota', 'Volkswagen', 'Fiat'),
            modelo: fc.constantFrom('AlternativeModel1', 'AlternativeModel2', 'AlternativeModel3', 'DifferentCar'),
            versao: versionGenerator,
        ...
        fc.assert(
            fc.property(
                ...
                (model, year) => {
                    ...
                    const expectedBodyType = model === 'Onix' ? 'Hatch' :
                        model === 'Civic' ? 'Sedan' :
                            model === 'Tracker' ? 'SUV' : 'Pickup';
            ...
            fc.property(
                ...
                (model, year) => {
                    ...
                    if (result.vehicles.length > 0) {
                        ...
                        const mentionsBodyType = reasoning.includes('carroceria') || reasoning.includes(expectedBodyType.toLowerCase());
