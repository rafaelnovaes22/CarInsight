...
import { simulateFinancing, formatFinancingSimulation, extractMoneyValue } from '../../src/services/financing-simulator.service';
...
describe('FinancingAgent', () => {
    ...
    beforeEach(() => {
        ...
        vi.mocked(simulateFinancing).mockReturnValue({
            ...
            interestRate: 0.015,
            installments: [
                { months: 48, monthlyPayment: 2000, totalPaid: 96000, totalInterest: 33000, totalInterestPaid: 33000 } as any
            ],
