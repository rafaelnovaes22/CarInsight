...
describe('E2E: Platform Eligibility System', () => {
    ...
    it('Scenario 1: Uber Black Candidate (Corolla 2024)', async () => {
        ...
        chatSpy.mockResolvedValue(JSON.stringify({
            transport: { uberX: true, uberComfort: true, uberBlack: true, pop99: true, comfort99: true, indrive: true },
        ...
        const vehicle = {
            marca: 'Toyota', modelo: 'Corolla Altis', ano: 2024,
            carroceria: 'Sedan', arCondicionado: true, portas: 4, cambio: 'Automatico'
        };
    ...
    it('Scenario 2: Popular Hatch (Onix 2019) - Should Fail Black', async () => {
        ...
        chatSpy.mockResolvedValue(JSON.stringify({
            transport: { uberX: true, uberComfort: true, uberBlack: false, pop99: true, comfort99: true },
        ...
        const vehicle = {
            marca: 'Chevrolet', modelo: 'Onix Plus', ano: 2019,
            carroceria: 'Sedan', arCondicionado: true, portas: 4, cambio: 'Automatico'
        };
    ...
    it('Scenario 3: Delivery Moto (Honda CG 160 2018)', async () => {
        ...
        const vehicle = {
            marca: 'Honda', modelo: 'CG 160 Fan', ano: 2018,
            carroceria: 'Moto', arCondicionado: false, portas: 0, cambio: 'Manual', cilindrada: 160
        };
    ...
    it('Scenario 4: Old Vehicle (Fusca 1980) - Should Fail All', async () => {
        ...
        const vehicle = {
            marca: 'Volkswagen', modelo: 'Fusca', ano: 1980,
            carroceria: 'Hatch', arCondicionado: false, portas: 2, cambio: 'Manual'
        };
