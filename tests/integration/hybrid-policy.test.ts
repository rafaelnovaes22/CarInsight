            ...
            recommendations: [
                {
                    vehicleId: 'valid-1',
                    matchScore: 0.9,
                    vehicle: { id: 'valid-1', brand: 'Toyota', model: 'Corolla Altis', year: 2022, bodyType: 'Sedan', price: 90000, mileage: 50000, transmission: 'Automatico' }
                },
                {
                    vehicleId: 'invalid-model',
                    matchScore: 0.85,
                    vehicle: { id: 'invalid-model', brand: 'Hyundai', model: 'HB20', year: 2022, bodyType: 'Hatch', price: 60000, mileage: 40000, transmission: 'Manual' }
                },
                {
                    vehicleId: 'invalid-year',
                    matchScore: 0.8,
                    vehicle: { id: 'invalid-year', brand: 'Ford', model: 'Focus', year: 2012, bodyType: 'Hatch', price: 40000, mileage: 120000, transmission: 'Manual' }
                }
            ] as any,
            totalCount: 3
        });
