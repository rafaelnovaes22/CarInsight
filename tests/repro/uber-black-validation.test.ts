...
import { handleUberBlackQuestion, UberHandlerResult } from '../../src/agents/vehicle-expert/processors/uber-handler';
...
describe('Uber Black Validation Fix', () => {
    ...
    it('should handle generic questions in handleUberBlackQuestion (return handled: true)', async () => {
        ...
        expect(vehicleSearchAdapter.search).toHaveBeenCalledWith('', expect.objectContaining({ aptoUberBlack: true }));
    });
});
