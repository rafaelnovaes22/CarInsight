...
describe('Preference Extractor - Pickup Issue Repro', () => {
    it('should NOT identify pickup for versatile/economical request', async () => {
        const input = "Bom, eu gostaria de um carro versátil, que seja econômico, porque eu não tenho uma renda muito grande, mas que eu posso usar tanto para o uso do dia a dia, como para viagens também.";
