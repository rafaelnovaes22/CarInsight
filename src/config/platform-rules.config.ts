    ...
    transport: {
        uber: {
            ...
            comfort: {
                ...
                features: ['ar_condicionado', '4_portas'],
                exclusions: [
                    'HB20', 'HB20S', 'Onix', 'Onix Plus', 'Gol', 'Ka', 'Ka Sedan',
                    'Sandero', 'Logan', 'Etios', 'Yaris', 'Cronos', 'Mobi', 'Kwid'
                ],
            },
            black: {
                name: 'Uber Black',
                ...
                exclusions: [
                    'HB20', 'HB20S', 'Onix', 'Onix Plus', 'Prisma', 'Cronos', 'Grand Siena',
                    'Voyage', 'Virtus', 'Ka', 'Ka Sedan', 'Yaris', 'Etios', 'Versa', 'City',
                    'Logan', 'Sandero', 'Fit', 'Duster', 'Ecosport'
                ],
            },
        },

        ninetyNine: { // 99Pop, 99Comfort
            pop: {
                name: '99 Pop',
