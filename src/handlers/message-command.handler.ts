...
Para começar, qual é o seu nome?`;
    ...
    checkGreeting(message: string): { isGreeting: boolean; isJustGreeting: boolean } {
        ...
        const isJustGreeting = this.greetingCommands.some(cmd => lowerMessage === cmd || lowerMessage === cmd + '!');
     ...
     */
    private async processDataRightsCommands(phoneNumber: string, message: string): Promise<string | null> {
        const lowerMessage = message.toLowerCase().trim();
