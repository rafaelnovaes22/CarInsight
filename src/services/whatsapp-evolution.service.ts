...
export class WhatsAppEvolutionService implements IWhatsAppService {
    ...
    async markMessageAsRead(messageId: string): Promise<void> {
        ...
        try {
            ...
            logger.debug('Failed to mark message as read on Evolution', { error: (error as any).message });
        }
    }
    ...
    async getMediaUrl(mediaId: string): Promise<string> {
        ...
        throw new Error('Method not implemented properly for Evolution yet. Webhook provides media data.');
    }
