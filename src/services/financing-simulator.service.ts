...
export function simulateFinancing(
    ...
    return {
        ...
        interestRate,
        installments,
        disclaimer: '⚠️ Valores estimados para referência. Condições reais dependem de análise de crédito.',
    };
}
 ...
 */
export function formatFinancingSimulation(simulation: FinancingSimulation, vehicleName: string): string {
