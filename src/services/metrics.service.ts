...
export async function getMetrics(period: MetricsPeriod = '24h'): Promise<MetricsResponse> {
    ...
    const avgMessagesPerConversation =
        totalConversations > 0 ? messageCount / totalConversations : 0;
    ...
    logger.info({ period, conversations: metrics.conversations.total, leads: metrics.leads.total }, 'MetricsService: Metrics generated');
